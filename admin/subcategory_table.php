...
// Fetch all subcategory data from the database
...
<body class="bg-gray-100 flex flex-col h-screen">
    ...
    <h1 class="text-3xl font-bold text-gray-800 mb-4 text-center">Subcategories Table</h1>
                ...
                <tbody>
                    <?php foreach ($subcategories as $subcategory) : ?>
                        <tr class="border-b hover:bg-gray-100 transition duration-300">
                            ...
                            <td class="p-3 text-gray-800 text-center"><?php echo $subcategory['category']; ?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
