<footer class="bg-gray-800 text-white p-4 fixed bottom-0 w-full md:flex md:items-center md:justify-between relative">
    ...
    <div class="mb-4 md:w-1/3 md:flex md:justify-center md:border-r md:border-white md:pr-4">
        ...
        <a href="https://twitter.com/home" target="_blank" rel="noopener noreferrer" class="text-white mx-2 mb-2">
            <i class="fab fa-twitter fa-2x"></i>
        </a>
        <a href="https://www.instagram.com/iv4o_moliv4o/" target="_blank" rel="noopener noreferrer" class="text-white mx-2 mb-2">
            <i class="fab fa-instagram fa-2x"></i>
        </a>
        <a href="https://github.com/slendermagican" target="_blank" rel="noopener noreferrer" class="text-white mx-2 mb-2">
    ...
    <div class="mb-4 md:mb-0 md:w-1/2 md:pl-4">
        ...
        <div>
            <a href="/privacy" class="text-blue-300">Privacy Policy</a> |
            <a href="/terms" class="text-blue-300">Terms of Service</a>
            <p class="mb-0 md:ml-auto">&copy; 2024 Ivak Divak LTD. All rights reserved.</p>
        </div>
    </div>
</footer>
